				...
				sections = {
					'home': {
						...
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-166753362-1', { 'page_path': '/' });
								},
							],
						},
					},
					'discography': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-166753362-1', { 'page_path': '/#discography' });
								},
							],
						},
					},
					'media': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-166753362-1', { 'page_path': '/#media' });
								},
							],
						},
					},
					'never': {
						...
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-166753362-1', { 'page_path': '/#never' });
								},
							],
						},
					},
					'want': {
						...
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-166753362-1', { 'page_path': '/#want' });
								},
							],
						},
					},
					'loose-screws': {
						...
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-166753362-1', { 'page_path': '/#loose-screws' });
								},
							],
						},
					},
					...
					'vis': {
						...
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-166753362-1', { 'page_path': '/#vis' });
								},
							],
						},
					},
					'assetstore': {
						...
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-166753362-1', { 'page_path': '/#assetstore' });
								},
							],
						},
					},
					'oldbackup': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-166753362-1', { 'page_path': '/#oldbackup' });
								},
							],
						},
					},
